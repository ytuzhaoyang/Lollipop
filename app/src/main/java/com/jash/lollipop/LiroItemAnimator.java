 ...
 * Time: 上午11:07
 */
public class LiroItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder, int i) {
        ...
        animation.setDuration(getRemoveDuration())
                .alpha(0).translationX(view.getWidth()).setStartDelay(i * 100).setListener(new VpaListenerAdapter() {
            @Override
    ...
    private void animateAddImpl(final RecyclerView.ViewHolder holder, int i) {
        final View view = holder.itemView;
        final ViewPropertyAnimatorCompat animation = ViewCompat.animate(view);
        mAddAnimations.add(holder);
        animation.translationX(0).alpha(1).setStartDelay(i * 100).setDuration(getAddDuration()).
