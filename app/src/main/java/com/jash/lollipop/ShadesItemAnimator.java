 ...
 * Time: 上午11:07
 */
public class ShadesItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration())
                .rotationX(-90).setListener(new VpaListenerAdapter() {
            @Override
    ...
    private void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.rotationX(0).setDuration(getAddDuration()).
